...
// This is the runtime entry point for the node
// we define the pallets that will be used in the runtime here and the runtime will be composed of these pallets
// this is similar with web2 where we define the routes and the server will be composed of these routes
